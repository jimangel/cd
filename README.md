...
| Workload Name             | Sync Wave | Sync Type                    | Core Config                                                                                           | Custom Shared Config (clusters)                                                                                                                                          | README.md                                             |
|---------------------------|-----------|------------------------------|-------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------|
...
| gatekeeper                | 0         | helm-remote-plus-yaml-local      | (Helm URL in AppSet)                                                                                  | [raw/](workloads/gatekeeper/config/raw/)                                                                                                                                 | [link](workloads/gatekeeper/README.md)                |
...
| istio                     | 0         | kustomize-nested-helm-remote | AppSet + [base/](workloads/istio/config/base/)                                                        | [overlays/](workloads/istio/config/overlays/) (Not In Use)                                                                                                               | [link](workloads/istio/README.md)                     |
| kube-prometheus-stack     | 0         | helm-remote-plus-helm-local  | AppSet + [environments/](workloads/kube-prometheus-stack/applicationset/environment) (Prod / Staging) | [addon-chart-gateway/](workloads/kube-prometheus-stack/config/addon-chart-gateway), [addon-chart-gateway/](workloads/kube-prometheus-stack/config/helm-values) (Staging) | [link](workloads/kube-prometheus-stack/README.md)     |
